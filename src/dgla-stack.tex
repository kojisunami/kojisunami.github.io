...
since the integration of Lie algebroid contains obstruction. 
Here I'll list several na\"{\i}ve questions below:

\begin{question}{}{}
\begin{itemize}
\item How to extend Lie algebroid to Lie groupoid?
\item What happens if the foliation is Lagrangian foliation?
\item Is there any connection to Fukaya category?
\item Is there any either $L_\infty$ deformation or quantization?
\end{itemize}
\end{question}

and some other stuffs. As somebody does it already, 
I'll introduce the technique of derived algebraic geometry to develop this foliation problem.

...
since the integration of Lie algebroid contains obstruction. Here as many people already does it, 
I'll introduce technique of derived algebraic geometry to resolve this problem. There's several questions:
...
\item Is there any either deformation or quantization as always?
\end{itemize}
\end{question}

and some other stuffs. These are.

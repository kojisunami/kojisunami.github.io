...
and $A_\infty$-enhancement $D^b(Coh(X))$ of derived category of coherent sheaves.
...
in Calabi-Yau manifold, and we named symplectic side as A-model, the complex side as B-model, 
...
but the proof of homological mirror symmetry isn't easy. \\

One motivation to study $A_\infty$-algebra is to study Fukaya category.

$A_\infty$ algebra is a generalization of commutative ring, and I'll use $A_\infty$ algebra to describe algebraic geometry.
...
\section{Geometric Realization of $A_\infty$}

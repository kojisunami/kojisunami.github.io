...
\begin{verbatim}
all: index.html random-thoughts.html cv-koji.pdf

index.html : index.tex style.css
    latexmlc index.tex --dest=index.html

misc.html : misc.tex style.css
    latexmlc misc.tex --dest=misc.html

random-thoughts.html : random-thoughts.tex style.css
...
Continuing from html compilation with Makefile, Makefile can automate the compilation to generate pdf files of research_notes or expositions, 
The following code compiles each project on "PROJECTS" respectively.
The reason why I use pdflatex 3 times is bibtex and maketitle issue:

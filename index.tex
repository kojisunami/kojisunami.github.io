...
\begin{tikzpicture}[auto]
    \node [block] (a) {Fukaya Category};
    \node [block, right of=a, node distance=5cm] (b) {Derived Category};
    \draw [<->] (a) -- node[name=u, above=5mm] {$ $} (b);
    \node[ block, fit=(a) (b) (u), inner sep=10pt ] {};
\end{tikzpicture}
\vspace{1cm}
...
\tikzstyle{block} = [draw, rectangle, minimum height=3em, minimum width=6em]
\begin{tikzpicture}[auto]
    \node [block] (a) {dg L_\infty Groupoid};
    \node [block, right of=a, node distance=5cm, text width=5cm, align=center] (b) {Geometrization of Foliation};
    \node [block, right of=b, node distance=5cm, text width=5cm, align=center] (c) {Fukaya Category};
    \draw [<->] (a) -- node[name=u, above=5mm] {$Globalization$} (b);
    \draw [<->] (b) -- node[name=v, above=5mm] {$Integration$} (c);
    \node[ block, fit=(a) (b) (c) (u) (v), inner sep=10pt ] {};
\end{tikzpicture}
\vspace{1cm}
\end{itemize}

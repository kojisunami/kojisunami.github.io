...
Now let's set some research questions. First of all, to introduce the application regarding questions of foliation beyond of itself,
QFT might be the obvious application, while we also further investigate the property of quotient stack itself.
Perhaps subjectively, Lie groupoid quotient is much more dirty than that of Lie group, but in order to make it something, 
considering the $M$ as simple as possible, hyperk\"ahler manifold, for example.
I'd also consider the computational method with Chevalley-Eilenberg, Donaldson-Thomas/Gromov-Witten invariants.
Another problem is to discuss what's the missing data when we define quotient stack of Lie groupoid.
...
\item Is there any either deformation or quantization?
\end{itemize}

(structure)
\begin{itemize}
\item Restricting geometry $M$ to hyperk\"ahler, or as simple as possible?
\item Computation of groupoid version of CE cohomology? DT/GW invariants?
\item Does quotient stack contains all the necessary information?
\end{itemize}
\end{question}
...
Algebraic geometry can be studied differential geometrically. Hodge structure, Symplectic structure, Lie algebra,
moduli problem, sheaf cohomology, singularity, derived method, and even counting problem are still domain of differential geometry,
...
While to briefly list up, algebraic geometry can better treat deformation, degeneration, singularty, intersection, geometric quotient etc. \\

To begin with, the purpose of geometry is to study the shape of geometry, and most audience will agree on it.
To identify the shape of geometry, consider how function behaves on the geometry as domain.

\subsection{Classic Algebraic Geometry}

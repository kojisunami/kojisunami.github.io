...
\begin{tikzpicture}[auto, every node/.style={font=\small}]
  ...
  \node (b) at (5,0) {Derived Category};
  \draw[-, shorten <= 15pt, shorten >= 3pt] (a) -- (b);
  \node[draw, rectangle, fit=(a) (b), inner sep=10pt ] {};
\end{tikzpicture}
\end{center}
\par\bigskip
...
\begin{tikzpicture}[auto, every node/.style={font=\small}]
    ...
    \node (b) at (5,0) {Quotient Stack};
    \node (c) at (10,0) {Fukaya Category};
  \draw[-, shorten <= 15pt, shorten >= 3pt] (a) -- (b);
  \draw[-, shorten <= 15pt, shorten >= 3pt] (b) -- (c);
    \node[draw, rectangle, fit=(a) (b) (c), inner sep=10pt ] {};
\end{tikzpicture}
\end{center}
\end{itemize}
\par\bigskip

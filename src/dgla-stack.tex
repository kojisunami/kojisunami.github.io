...
Now here is the developing question. Suppose two distinct Lagrangian folations $\mathcal{F}_1$ and $\mathcal{F}_2$ on the same geometry $M$,
what is the intersection between them? 
Namely, this is an intersection theory of moduli stack.
Even though stack is defined in Grothendieck topology, radically speaking, moduli space is not a geometry itself, it's just a generalization.
If that is the case, I'll claim the geometrization of moduli stack.

In order to define intersection theory, derived algebraic geometry might be needed.


Or if there is 
possibly enhancing dg $L_\infty$ algebroid from Lie algebroid?



As a comparison with $A_\infty$, is there any notion of $L_\infty$ category,
and once we make it, is there any connection .


\begin{minipage}{0.48\textwidth}
This is the left side.

You can put sentences here.
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
This is the right side.

You can put a diagram here:
